...
| 1キー| タップ＝戻る（MB4） / ホールド＝Ctrl矢印（押しながら2/3キー）|
| 2キー| スクロールON/OFFトグル（スクロールレイヤーへ） |
| 3キー| 左クリック |
| 1キー + 2キー（同時押し）| 進む（マウス進むボタン / MB5） |
| 1キーを押しながら 2キー| Ctrl + ←（前のページへ / 戻る） |
| 1キーを押しながら 3キー| Ctrl + →（次のページへ / 進む） |
| 2キー + 3キー| 右クリック |
...
>[!NOTE]
>**・2キーで切り替え。有効中はトラックボールがスクロールホイールになります。3キーで解除します。**
